...
# e = client.execute('SELECT a_t_a_result.arrival_a_t_a FROM snapp_raw_log.khatkesh_result_proto LIMIT 1')
# print(e)

c = client.execute("SELECT * FROM snapp_raw_log.khatkesh_result_proto WHERE toDate(clickhouse_time, 'Iran') BETWEEN '2022-09-07' AND '2022-09-07' AND toHour(clickhouse_time, 'Iran') BETWEEN 17 AND 20")

with open('../khatkesh_07.csv', 'w') as f:
